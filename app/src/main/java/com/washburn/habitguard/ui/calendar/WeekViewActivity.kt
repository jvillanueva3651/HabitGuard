...
class WeekViewActivity : AppCompatActivity(), CalendarAdapter.OnItemListener {
    ...
    private fun initViews() {
        binding.apply {
            ...
            calendarRecyclerView.layoutManager = GridLayoutManager(this@WeekViewActivity, 7).apply {
            ...
            // Setup events list
            eventListView.layoutManager = LinearLayoutManager(this@WeekViewActivity)
        }
    }
